 ...
 **************************************************/
#define SEG_GPU_DVFS_FREQ0			(1209000)/* KHz */
#define SEG_GPU_DVFS_FREQ1			(995000)/* KHz */
#define SEG_GPU_DVFS_FREQ2			(970000)/* KHz */
#define SEG_GPU_DVFS_FREQ3			(955000)/* KHz */
...
#define SEG_GPU_DVFS_VOLT1		(99500)/* mV x 100 */
#define SEG_GPU_DVFS_VOLT2		(97000)/* mV x 100 */
#define SEG_GPU_DVFS_VOLT3		(89500)/* mV x 100 */
...
#define SEG_GPU_DVFS_VSRAM0		(117000)/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM1		(172500)/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM2		(150000)/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM3		(99500)/* mV x 100 */
...
#define SEG_GPU_DVFS_VSRAM11	(85000)
