...
#define SEG_GPU_DVFS_VOLT0		(106250)	/* mV x 100 */
#define SEG_GPU_DVFS_VOLT1		(103750)	/* mV x 100 */
#define SEG_GPU_DVFS_VOLT2		(101250)	/* mV x 100 */
#define SEG_GPU_DVFS_VOLT3		(98750)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT4		(97500)		/* mV x 100 */
...
#define SEG_GPU_DVFS_VSRAM0		(112500)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM1		(110000)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM2		(107500)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM3		(105000)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM4		(102500)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM5		(100000)	/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM6		(97500)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM7		(96875)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM8		(95625)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM9		(94375)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM10	(93125)		/* mV x 100 */
#define SEG_GPU_DVFS_VSRAM11	(92500)		/* mV x 100 */
